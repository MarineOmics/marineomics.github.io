...
ggplot(data = rt_df, aes(x = rt, fill = as.factor(t_size), group = as.factor(t_size))) +
  geom_histogram(data = filter(rt_df, t_mu == 25), alpha = 0.75) +
  geom_histogram(data = filter(rt_df, t_mu == 75), alpha = 0.75) +
  theme_classic() +
  labs(title = "Simulated negative binomial distribution", fill = "Mean", y = "Frequency", x = "Mean")
