...
build specific features (eg., tables, code chunks). Prior to publishing
...
-   add your citations to the RCN_site-Nov05.bib document by exporting
    BibTeX-formatted citations from your reference manager
-   add the line 'bibliography: RCN_site-Nov05.bib' to your header at
