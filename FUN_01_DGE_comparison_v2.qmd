...
# Make contrasts
is.de_nl_pCO2 <-
  decideTests(nl_pCO2, adjust.method = "fdr", p.value = 0.05)
is.de_nl_pCO2_2 <-
  decideTests(nl_pCO2_2, adjust.method = "fdr", p.value = 0.05)
...
# Make contrasts
is.de_nl_pCO2_int <-
  decideTests(nl_pCO2_int, adjust.method = "fdr", p.value = 0.05) # Make contrasts
is.de_nl_pCO2_2_int <-
  decideTests(nl_pCO2_2_int, adjust.method = "fdr", p.value = 0.05)
...
is.de_tr_pCO2 <-
  decideTests(tr_pCO2, adjust.method = "fdr", p.value = 0.05) # Make contrasts
...
is.de_int <-
  decideTests(tr_int, adjust.method = "fdr", p.value = 0.05) # Make contrasts
