...
author: "*Yaamini Venkataraman*, *Kathryn Greiner-Ferris*, *Sam White*, and *Steven Roberts*"
...
#| out-width: "70%"
#| fig-align: center
#| fig-cap: "Frequency distribution of methylation ratios for CpG dinucleotides in oyster gill tissue. [@10.7717/peerj.215](#refs)"
...
#| out-width: "100%"
#| fig-align: center
#| fig-cap: "Screenshot from IGV. Bedgraph files are displayed. See below for code to create these file (File Conversion)"
...
#| out-width: "70%"
#| fig-align: center
#| fig-cap: "Genome screenshots of methylation quantified in 2kb running windows over the first 3Mb of chromosome 1 zebrafish and mouse, and of the largest scaffold (NW_006890054.1) in elephant shark (doi: 10.12688/f1000research.11281.1)"
