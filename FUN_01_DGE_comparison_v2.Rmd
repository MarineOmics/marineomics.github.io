...
bibliography: FUN_01_DGE_comparison_v2_files/DGE_Comp.bib
output: 
  html_document:
    pandoc_args: [ 
      "--output=DGE_comparison_v2.html" 
    ]
---
...
data <- read.delim("FUN_01_DGE_comparison_v2_files/RNA_data/GE2_expected_counts_gene.matrix", sep = "\t", header = T, row.names = 1)
...
knitr::include_graphics("FUN_01_DGE_comparison_v2_files/Rivera_etal_fig.png")
