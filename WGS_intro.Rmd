...
* [Fastq-to-VCF SnakeMake pipeline](fastq2vcf_pipeline.html): in-depth explanation of an automated short-read mapping and variant calling pipeline maintained by [Harvard Informatics](https://github.com/harvardinformatics/shortRead_mapping_variantCalling). Useful if you plan to adopt this pre-packaged automated and parallelizable pipeline, would like to understand its different components but not necessarily change it substantially.
