...
Use text-annotated code notebooks for bioinformatic analyses (e.g., Quarto, Jupyter).
...
Provide these notebooks (in Quarto or Jupyter) in a publicly accessible format on services such as GitHub, GitLab, Dryad, Figshare, or Zenodo.
