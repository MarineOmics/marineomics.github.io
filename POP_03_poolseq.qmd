...
![Manhattan plot of mean Fst values for 10,000-bp windows of all the selected lines versus the pure Bodega population.](POP_03_poolseq/Fst_SvsBR_SDmap.png)
...
![Principle coordinate analysis of allele frequencies for selected lines (red), control lines (blue), the pure Bodega population (white), and the pure San Diego population (black).](POP_03_poolseq/pi_PCA.png)
