...
- File conversions
- Potential downstream applications. Although this tutorial will not provide code for downstream applications, it will link to other open-access resources and examples.
