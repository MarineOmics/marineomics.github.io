...
```{r meth-summary, echo = FALSE, out.width = "70%", fig.align = "center"}
...
The resulting could be used to mask the genome and the entire process described above could be repeated (ie Genome Preparation, Alignment, Quantification)
