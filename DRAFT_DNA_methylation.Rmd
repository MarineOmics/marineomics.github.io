...
One way to do this is using BS-Snper (@10.1093/bioinformatics/btv507). <https://github.com/hellbelly/BS-Snper>. In short one could merge all BAM files from experiment run BS-Snper, filter out C->T SNPS then use this to remove loci.
