...
```{r meth-vert, echo = FALSE, out.width = "70%", fig.align = "center", fig,cap= "Genome screenshots of methylation quantified in 2kb running windows over the first 3Mb of chromosome 1 zebrafish and mouse, and of the largest scaffold (NW_006890054.1) in elephant shark."}
...
-   Gene-level methylation analysis: see [@. It is worth considering the utility of converting loci-level resolution data to gene-level resolution data. 
...
-   Feature overlap. see [@10.1186/s12864-022-08781-5](#refs) Bedtools for quantitative assessment and IGV for visual assessment are valuable for this.
