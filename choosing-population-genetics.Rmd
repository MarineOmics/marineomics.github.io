...
High-coverage (>20x) sequencing is able to find rare variants with high confidence. This approach is considered the is the 'gold standard' for DNA resequencing because it includes all variant types (i.e SNVs, indels, structural variants and CNVs) [@sims2014sequencing]. 
...
## 2) Reduced-representation sequencing {.unlisted .unnumbered}
...
## 3) Pooled individuals (Poolseq)  {.unlisted .unnumbered}
